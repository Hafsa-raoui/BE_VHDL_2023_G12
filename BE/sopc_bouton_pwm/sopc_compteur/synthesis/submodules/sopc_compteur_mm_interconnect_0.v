...
module sopc_compteur_mm_interconnect_0 (
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> avalon_pwm_0_avalon_slave_0_agent:cp_valid
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> avalon_pwm_0_avalon_slave_0_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // avalon_pwm_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> avalon_pwm_0_avalon_slave_0_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> avalon_pwm_0_avalon_slave_0_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> avalon_pwm_0_avalon_slave_0_agent:cp_endofpacket
	...
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> SYST_ID_control_slave_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> SYST_ID_control_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // SYST_ID_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> SYST_ID_control_slave_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> SYST_ID_control_slave_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> SYST_ID_control_slave_agent:cp_endofpacket
	...
	wire   [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> LEDS_s1_agent:cp_channel
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> BOUTONS_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> BOUTONS_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // BOUTONS_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> BOUTONS_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> BOUTONS_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> BOUTONS_s1_agent:cp_endofpacket
	...
	wire         avalon_pwm_0_avalon_slave_0_agent_rp_valid;                                // avalon_pwm_0_avalon_slave_0_agent:rp_valid -> router_003:sink_valid
	wire  [92:0] avalon_pwm_0_avalon_slave_0_agent_rp_data;                                 // avalon_pwm_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	wire         avalon_pwm_0_avalon_slave_0_agent_rp_ready;                                // router_003:sink_ready -> avalon_pwm_0_avalon_slave_0_agent:rp_ready
	wire         avalon_pwm_0_avalon_slave_0_agent_rp_startofpacket;                        // avalon_pwm_0_avalon_slave_0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         avalon_pwm_0_avalon_slave_0_agent_rp_endofpacket;                          // avalon_pwm_0_avalon_slave_0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         syst_id_control_slave_agent_rp_valid;                                      // SYST_ID_control_slave_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] syst_id_control_slave_agent_rp_data;                                       // SYST_ID_control_slave_agent:rp_data -> router_004:sink_data
	wire         syst_id_control_slave_agent_rp_ready;                                      // router_004:sink_ready -> SYST_ID_control_slave_agent:rp_ready
	wire         syst_id_control_slave_agent_rp_startofpacket;                              // SYST_ID_control_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         syst_id_control_slave_agent_rp_endofpacket;                                // SYST_ID_control_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         boutons_s1_agent_rp_valid;                                                 // BOUTONS_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] boutons_s1_agent_rp_data;                                                  // BOUTONS_s1_agent:rp_data -> router_008:sink_data
	wire         boutons_s1_agent_rp_ready;                                                 // router_008:sink_ready -> BOUTONS_s1_agent:rp_ready
	wire         boutons_s1_agent_rp_startofpacket;                                         // BOUTONS_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         boutons_s1_agent_rp_endofpacket;                                           // BOUTONS_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         avalon_pwm_0_avalon_slave_0_agent_rdata_fifo_src_valid;                    // avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] avalon_pwm_0_avalon_slave_0_agent_rdata_fifo_src_data;                     // avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         avalon_pwm_0_avalon_slave_0_agent_rdata_fifo_src_ready;                    // avalon_st_adapter_001:in_0_ready -> avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> avalon_pwm_0_avalon_slave_0_agent:rdata_fifo_sink_error
	wire         syst_id_control_slave_agent_rdata_fifo_src_valid;                          // SYST_ID_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] syst_id_control_slave_agent_rdata_fifo_src_data;                           // SYST_ID_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         syst_id_control_slave_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_002:in_0_ready -> SYST_ID_control_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> SYST_ID_control_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> SYST_ID_control_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                         // SYST_ID_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> SYST_ID_control_slave_agent:rdata_fifo_sink_error
	...
	wire         boutons_s1_agent_rdata_fifo_src_valid;                                     // BOUTONS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] boutons_s1_agent_rdata_fifo_src_data;                                      // BOUTONS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         boutons_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> BOUTONS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> BOUTONS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> BOUTONS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // BOUTONS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> BOUTONS_s1_agent:rdata_fifo_sink_error
