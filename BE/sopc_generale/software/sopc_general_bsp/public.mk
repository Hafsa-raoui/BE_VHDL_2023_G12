...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../sopc_anemometre.sopcinfo
...
# Design Name 
# setting SOPC_NAME is sopc_anemometre
SOPC_NAME := sopc_anemometre
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11090
SOPC_SYSID_FLAG += --sidp=0x11090
ELF_PATCH_FLAG  += --sidp 0x11090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1701966132
SOPC_SYSID_FLAG += --timestamp=1701966132
ELF_PATCH_FLAG  += --timestamp 1701966132
