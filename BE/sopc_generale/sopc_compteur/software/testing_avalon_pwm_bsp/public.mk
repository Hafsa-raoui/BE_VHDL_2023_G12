...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../sopc_compteur.sopcinfo
...
# Design Name 
# setting SOPC_NAME is sopc_compteur
SOPC_NAME := sopc_compteur
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11050
SOPC_SYSID_FLAG += --sidp=0x11050
ELF_PATCH_FLAG  += --sidp 0x11050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1701635155
SOPC_SYSID_FLAG += --timestamp=1701635155
ELF_PATCH_FLAG  += --timestamp 1701635155
